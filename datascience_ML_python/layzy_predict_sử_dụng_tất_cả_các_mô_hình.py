...
# thư viện này 
#  cái này giúp thử cho chúng ta tất cả các mô hình cùng lúc
import pandas as pd  
...
#import lớp LazyClassifier từ thư viện lazypredict để học máy tự động , dùng để thử các mô hình vào xem nó như thế nào
...
models , predictions = clf.fit(x_train , x_test ,y_train,y_test)
print(models)
# Kinh nghiệm ta sẽ sử dụng tham số tốt nhất 5,10 ta sẽ sử dụng bộ siêu tham số tốt nhất 
# cho nó
# f1 , Accuracy càng cao càng tốt
