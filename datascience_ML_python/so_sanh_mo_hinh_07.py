...
# print("F1 {}".format(f1_score(f1_score(y_test,y_predict))))
...
# weighted avg (Trung bình có trọng số giữa các mô hình với nhau 
# )     0.73      0.73      0.73       154


#Kết quả ramdomforest
...
# Chúc ta dựa trên các chỉ số của nó lên xem recall cao thì có thể nhận xem các mô hình of nó với nhau 
