# CÂN BẰNG DỮ LIỆU TÙY THÍCH ==>NÓ KHÔNG MẶC ĐỊNH NHƯ CÁI BAN ĐẦU
# kĩ thuật cân bằng dữ liệu
import pandas as pd
...
model = Pipeline(steps=[
    ...
    ("feature_selector",SelectPercentile(score_func=chi2,k=10)), # giữ lại 10%
